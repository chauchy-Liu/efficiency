...
def write_word(path_farm,WindFarm,Input_startTime,Input_endTime,Turbine_attr,wind_freq,wind_max,wind_mean,month_data,wind_ti_alltype):
    document = Document()
    
    
    windfarm_erji = WindFarm.loc[0,'二级公司']
    windfarm_name = WindFarm.loc[0,'风电场名']
    windfarm_postion = WindFarm.loc[0,'地址']
    windfarm_capi = WindFarm.loc[0,'容量']
    windfarm_amount = WindFarm.loc[0,'风机台数']
    windfarm_wttpye = WindFarm.loc[0,'机型']
    windfarm_date = WindFarm.loc[0,'并网日期']
    windfarm_siteType = siteType[(siteType['siteType_ID'] == WindFarm.loc[0,'风资源'])]['siteType_name'].values[0]
    windfarm_yunyingzhongxin = WindFarm.loc[0,'生产运营中心']
    windfarm_resourceType = resourceType[(resourceType['resourceType_ID'] == WindFarm.loc[0,'风资源'])]['resourceType_name'].values[0]
    trubine_type = len( np.unique(Turbine_attr['turbineTypeID']))
    ...
    paragraph_text = str(windfarm_erji + windfarm_name+'位于'+str(windfarm_postion)+'，装机容量'+str(windfarm_capi)+'MW，共计'+str(int(windfarm_amount))+'台机组，机组型号：'+windfarm_wttpye+'，并网时间'+str(windfarm_date)+'。'+
                         ...
                         '本次发电场能效评估时间段位为'+str(Input_startTime)+'至'+str(Input_endTime)+'，数据源来自集团公司产业数据中台，评估维度包括：风资源分析、损失电量分析、机组控制性能分析等。')
    paragraph = document.add_paragraph()
    ...
    for i in range(device_num):
        for j in range(12):
            if i == 0:
                ...
                path = str(str(path_farm)+'/'+str(np.unique(Turbine_attr['turbineTypeID'])[i-1]))
                metric_tongji = pd.read_csv(str(path+'/tongji.csv'),header=[0],index_col=[0])
                loss_power = metric_tongji.loc[0]['fault_loss']+metric_tongji.loc[0]['limgrid_loss']+metric_tongji.loc[0]['faultgrid_loss']+metric_tongji.loc[0]['limturbine_loss']+metric_tongji.loc[0]['stop_loss']+metric_tongji.loc[0]['Technology_loss']
                if j == 0:
                    fill_table(tablez0_2, x=i, y=j, content=str(str(np.unique(Turbine_attr['turbineTypeID'])[i-1])), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                elif j == 1:
                    fill_table(tablez0_2, x=i, y=j, content=int(len(Turbine_attr[Turbine_attr['turbineTypeID']==np.unique(Turbine_attr['turbineTypeID'])[i-1]])), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                elif j == 2:
                    fill_table(tablez0_2, x=i, y=j, content='{:.2f}'.format(metric_tongji.loc[0,'wspd']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                elif j == 3:
                    fill_table(tablez0_2, x=i, y=j, content='{:.1f}'.format(metric_tongji.loc[0,'eny']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                elif j == 4:
                    fill_table(tablez0_2, x=i, y=j, content='{:.1f}'.format(metric_tongji.loc[0,'hour']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                elif j == 5:
                    fill_table(tablez0_2, x=i, y=j, content=metric_tongji.loc[0,'eny_avail'], font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                elif j == 6:
                    fill_table(tablez0_2, x=i, y=j, content=metric_tongji.loc[0,'time_avail'], font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j])
                elif j == 7:
                    fill_table(tablez0_2, x=i, y=j, content='{:.1f}'.format(metric_tongji.loc[0,'MTBT']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j])
                elif j == 8:
                    ...
                    fill_table(tablez0_2, x=i, y=j, content=metric_tongji.loc[0,'qifenglv'], font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j])
                elif j == 10:
                    fill_table(tablez0_2, x=i, y=j, content=metric_tongji.loc[0,'fault_misstime'], font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j])
                elif j == 11:
                    fill_table(tablez0_2, x=i, y=j, content=metric_tongji.loc[0,'notfault_time'], font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j])
    ...
    for i in range(trubine_type):
        ...
        paragraph_picture0_3_run.add_picture(str(figure_path),width=Cm(14))
        if i == 0:
            paragraph_picture0_3.paragraph_format.space_before = Pt(15)
        paragraph_picture0_3.paragraph_format.space_after = Pt(0)
        #图示
        picture_num += 1
        paragraph0_3_text = str('图'+str(picture_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[i])+'机组实发电量、风速统计图')
    ...
    #图2
    figure_path = str(str(path_farm)+'/'+'zuobiao_all.png')
    ...
    paragraph_picture0_5_run.add_picture(str(figure_path),width=Cm(14))
...
##########################################################################################
    ...
    paragraph1_1_text = '风电场评估周期内平均风速'+'{:.2f}'.format(wind_mean)+'m/s，最大风速'+'{:.2f}'.format(wind_max)+'m/s，风频主要集中在'+'{:.2f}'.format(min_speed)+'～'+'{:.2f}'.format(max_speed)+'m/s风速区间，图'+str(picture_num)+'为风频分布图。' 
    ...
    #图3
    figure_path = str(str(path_farm)+'/'+'windfreq.png')
    ...
    paragraph_picture1_2_run.add_picture(str(figure_path),width=Cm(14))
    ...
    #文字
    picture_num += 1
    mean_rho = month_data['rho'].mean()
    max_speed_month = month_data['wspd'].idxmax()
    ...
    #图4
    figure_path = str(str(path_farm)+'/'+'month.png')
    ...
    paragraph_picture1_4_run.add_picture(str(figure_path),width=Cm(14))
    ...
    #图5    
    row_num = math.ceil(len(Turbine_attr)/2)
    ...
    wtids = Turbine_attr[Turbine_attr['turbineTypeID']==np.unique(Turbine_attr['turbineTypeID'])[trubine_type_i]]['name']
    turbine_num = len(wtids)
    for i in range(row_num):
        for j in range(2):
            if ((i*2+j+1) > turbine_num):
                if (i*2+j+1)>len(Turbine_attr):
                    break
            ...
            figure_path = str(path+'/'+str(wtids.iloc[num])+'风向玫瑰图.png')
    ...
    if (np.nanmax(wind_ti_alltype['windbin']) >= 15.0)&(15.0 in wind_ti_alltype['windbin'].values):
        ...
        if np.nanmean(wind_ti_alltype['ti']) > 0.12:
            str_temp = '湍流强度较大。'
        else:
            str_temp = '湍流强度较小。'
    ...
    #图4
    picture_num += 1
    figure_path = str(str(path_farm)+'/'+'湍流曲线.png')
    paragraph_picture1_4 = document.add_paragraph()
    paragraph_picture1_4.alignment = WD_ALIGN_PARAGRAPH.CENTER
    paragraph_picture1_4_run = paragraph_picture1_4.add_run()
    paragraph_picture1_4_run.add_picture(str(figure_path),width=Cm(14))
...
##########################################################################################
    ...
    for i in range(trubine_type):
        ...
        metric_tongji = pd.read_csv(str(path+'/tongji.csv'),header=[0],index_col=[0])
        loss_power = metric_tongji.loc[0]['fault_loss']+metric_tongji.loc[0]['limgrid_loss']+metric_tongji.loc[0]['faultgrid_loss']+metric_tongji.loc[0]['limturbine_loss']+metric_tongji.loc[0]['stop_loss']+metric_tongji.loc[0]['Technology_loss']
        paragraph2_1_text = ('分析时段内，'+windfarm_name+str(np.unique(Turbine_attr['turbineTypeID'])[i])+'机型各类损失电量共计'+'{:.1f}'.format(loss_power)+'kWh，占应发电量'+'{:.2f}'.format(100-float(metric_tongji.loc[0,'eny_avail'][0:-1]))+'%。'+
                             '其中风机机组故障损失电量'+'{:.1f}'.format(metric_tongji.loc[0]['fault_loss'])+'kWh，'+
                             '电网限电损失电量'+'{:.1f}'.format(metric_tongji.loc[0]['limgrid_loss'])+'kWh，'+
                             '电网故障损失电量'+'{:.1f}'.format(metric_tongji.loc[0]['faultgrid_loss'])+'kWh，'+
                             '机组自限电损失电量'+'{:.1f}'.format(metric_tongji.loc[0]['limturbine_loss'])+'kWh，'+
                             '机组技术待机损失电量'+'{:.1f}'.format(metric_tongji.loc[0]['Technology_loss'])+'kWh，'+
                             '计划停机损失电量'+'{:.1f}'.format(metric_tongji.loc[0]['stop_loss'])+'kWh。')
    ...
    for typei in range(trubine_type):
        ...
        path = str(str(path_farm)+'/'+str(np.unique(Turbine_attr['turbineTypeID'])[typei]))
        fault_loss_all = pd.read_csv(str(path+'/fault_loss_all.csv'),header=[0],index_col=[0])
        
        if (metric_tongji.loc[0]['fault_loss'] > 200)&(len(fault_loss_all)>0):
            paragraph2_1_text = ('分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组故障损失电量共'+'{:.1f}'.format(metric_tongji.loc[0]['fault_loss'])+'kWh，折合等效小时'+
                                '{:.1f}'.format(metric_tongji.loc[0]['fault_loss']/WindFarm.loc[0,'容量']/1000)+'h，故障频次及详细故障损失统计见下图表，其中***故障发生频次较高。')   
            paragraph2_1 = document.add_paragraph()
            paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
            paragraph2_1_run.font.size = Pt(12)
            paragraph2_1_run.font.name = '仿宋'
            ...
            #图补
            figure_path = str(str(path_farm)+'/'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'/'+'fault.png')
            ...
            #图示
            picture_num += 1
            paragraph2_4_text = str('图'+str(picture_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型故障频次饼状图')
            ...
            #表例
            table_num = table_num + 1
            paragraph2_5_text = str('表'+str(table_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型故障损失统计表')
            ...
            for i in range(device_num):
                for j in range(len(column_width)):
                    if i == 0:
                        ...
                        if j == 0:
                            fill_table(tablez2_5, x=i, y=j, content=conver_to_str(fault_loss_all.iloc[i-1]['wtid']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 1:
                            fill_table(tablez2_5, x=i, y=j, content=int(fault_loss_all.iloc[i-1]['fault']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 2:
                            fill_table(tablez2_5, x=i, y=j, content=int(fault_loss_all.iloc[i-1]['count']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 3:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(fault_loss_all.iloc[i-1]['time']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 4:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(fault_loss_all.iloc[i-1]['loss']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 5:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(fault_loss_all.iloc[i-1]['wspd']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 6:
                            fill_table(tablez2_5, x=i, y=j, content=str(fault_loss_all.iloc[i-1]['fault_describe']), font_name='仿宋', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
        else:
            paragraph2_1_text = '分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组运行良好，故障极少，损失电量不到200kWh。'      
            paragraph2_1 = document.add_paragraph()
            paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
            paragraph2_1_run.font.size = Pt(12)
            paragraph2_1_run.font.name = '仿宋'
    ...
    for typei in range(trubine_type):
        ...
        path = str(str(path_farm)+'/'+str(np.unique(Turbine_attr['turbineTypeID'])[typei]))
        limgrid_loss_all = pd.read_csv(str(path+'/limgrid_loss_all.csv'),header=[0],index_col=[0])
        
        if (metric_tongji.loc[0]['limgrid_loss'] > 200)&(len(limgrid_loss_all)>0):
            paragraph2_1_text = ('分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组电网限电损失电量共'+'{:.1f}'.format(metric_tongji.loc[0]['limgrid_loss'])+'kWh，折合等效小时'+
                                '{:.1f}'.format(metric_tongji.loc[0]['limgrid_loss']/WindFarm.loc[0,'容量']/1000)+'h，各机组详细统计见下表。')
            paragraph2_1 = document.add_paragraph()
            paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
            paragraph2_1_run.font.size = Pt(12)
            paragraph2_1_run.font.name = '仿宋'
            ...
            #表例
            table_num = table_num + 1
            paragraph2_5_text = str('表'+str(table_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型电网限电损失统计表')
            paragraph2_5 = document.add_paragraph()
            paragraph2_5_run = paragraph2_5.add_run(paragraph2_5_text)
            paragraph2_5_run.font.size = Pt(10)
            paragraph2_5_run.font.name = '黑体'
            ...
            for i in range(device_num):
                for j in range(len(column_width)):
                    if i == 0:
                        ...
                        if j == 0:
                            fill_table(tablez2_5, x=i, y=j, content=conver_to_str(limgrid_loss_all.index[i-1]), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 1:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(limgrid_loss_all.iloc[i-1]['time']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 2:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(limgrid_loss_all.iloc[i-1]['loss']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 3:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(limgrid_loss_all.iloc[i-1]['wspd']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        
        else:
            paragraph2_1_text = '分析时段内依据产业数据中台数据统计，'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组未发生电网限电情况。'      
            paragraph2_1 = document.add_paragraph()
            paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
            paragraph2_1_run.font.size = Pt(12)
            paragraph2_1_run.font.name = '仿宋'
   ...
   #文字
    ...
    for typei in range(trubine_type):
        ...
        path = str(str(path_farm)+'/'+str(np.unique(Turbine_attr['turbineTypeID'])[typei]))
        limturbine_loss_all = pd.read_csv(str(path+'/limturbine_loss_all.csv'),header=[0],index_col=[0])
        
        if (metric_tongji.loc[0]['limturbine_loss'] >= 0)&(len(limturbine_loss_all)>0):
            paragraph2_1_text = ('分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组自限电损失电量共'+'{:.1f}'.format(metric_tongji.loc[0]['limturbine_loss'])+'kWh，折合等效小时'+
                                '{:.1f}'.format(metric_tongji.loc[0]['limturbine_loss']/WindFarm.loc[0,'容量']/1000)+'h，各机组详细统计见下表。自限电原因分析*****')
            paragraph2_1 = document.add_paragraph()
            paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
            paragraph2_1_run.font.size = Pt(12)
            paragraph2_1_run.font.name = '仿宋'
            ...
            #表例
            table_num = table_num + 1
            paragraph2_5_text = str('表'+str(table_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型自限电损失统计表')
            paragraph2_5 = document.add_paragraph()
            paragraph2_5_run = paragraph2_5.add_run(paragraph2_5_text)
            paragraph2_5_run.font.size = Pt(10)
            paragraph2_5_run.font.name = '黑体'
            ...
            for i in range(device_num):
                for j in range(len(column_width)):
                    if i == 0:
                        ...
                        if j == 0:
                            fill_table(tablez2_5, x=i, y=j, content=conver_to_str(limturbine_loss_all.index[i-1]), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 1:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(limturbine_loss_all.iloc[i-1]['time']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 2:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(limturbine_loss_all.iloc[i-1]['loss']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 3:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(limturbine_loss_all.iloc[i-1]['wspd']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        
        else:
            paragraph2_1_text = '分析时段内依据产业数据中台数据统计，'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组未发生自限电情况。'      
            paragraph2_1 = document.add_paragraph()
            paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
            paragraph2_1_run.font.size = Pt(12)
            paragraph2_1_run.font.name = '仿宋'
    ...
    for typei in range(trubine_type):
        ...
        path = str(str(path_farm)+'/'+str(np.unique(Turbine_attr['turbineTypeID'])[typei]))
        faultgrid_loss_all = pd.read_csv(str(path+'/faultgrid_loss_all.csv'),header=[0],index_col=[0])
        
        if (metric_tongji.loc[0]['faultgrid_loss'] > 200)&(len(faultgrid_loss_all)>0):
            paragraph2_1_text = ('分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组因电网故障发生的损失电量共'+'{:.1f}'.format(metric_tongji.loc[0]['faultgrid_loss'])+'kWh，折合等效小时'+
                                '{:.1f}'.format(metric_tongji.loc[0]['faultgrid_loss']/WindFarm.loc[0,'容量']/1000)+'h，详细故障损失统计见下表，其中***故障发生频次较高。')   
            paragraph2_1 = document.add_paragraph()
            paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
            paragraph2_1_run.font.size = Pt(12)
            paragraph2_1_run.font.name = '仿宋'
            ...
            #表例
            table_num = table_num + 1
            paragraph2_5_text = str('表'+str(table_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'电网故障损失统计表')
            paragraph2_5 = document.add_paragraph()
            paragraph2_5_run = paragraph2_5.add_run(paragraph2_5_text)
            paragraph2_5_run.font.size = Pt(10)
            paragraph2_5_run.font.name = '黑体'
            ...
            for i in range(device_num):
                for j in range(len(column_width)):
                    if i == 0:
                        ...
                        if j == 0:
                            fill_table(tablez2_5, x=i, y=j, content=conver_to_str(faultgrid_loss_all.iloc[i-1]['wtid']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 1:
                            fill_table(tablez2_5, x=i, y=j, content=int(faultgrid_loss_all.iloc[i-1]['fault']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 2:
                            fill_table(tablez2_5, x=i, y=j, content=int(faultgrid_loss_all.iloc[i-1]['count']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 3:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(faultgrid_loss_all.iloc[i-1]['time']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 4:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(faultgrid_loss_all.iloc[i-1]['loss']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 5:
                            fill_table(tablez2_5, x=i, y=j, content=str(faultgrid_loss_all.iloc[i-1]['fault_describe']), font_name='仿宋', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
        else:
            paragraph2_1_text = '分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组未发生电网侧故障。'      
            paragraph2_1 = document.add_paragraph()
            paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
            paragraph2_1_run.font.size = Pt(12)
            paragraph2_1_run.font.name = '仿宋'
    ...
    for typei in range(trubine_type):
        ...
        path = str(str(path_farm)+'/'+str(np.unique(Turbine_attr['turbineTypeID'])[typei]))
        Technology_loss_all = pd.read_csv(str(path+'/Technology_loss_all.csv'),header=[0],index_col=[0])
        
        if (metric_tongji.loc[0]['Technology_loss'] > 200)&(len(Technology_loss_all)>0):
            paragraph2_1_text = ('分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组技术待机损失电量共'+'{:.1f}'.format(metric_tongji.loc[0]['Technology_loss'])+'kWh，折合等效小时'+
                                '{:.1f}'.format(metric_tongji.loc[0]['Technology_loss']/WindFarm.loc[0,'容量']/1000)+'h，详细损失统计见下表。')   
            paragraph2_1 = document.add_paragraph()
            paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
            paragraph2_1_run.font.size = Pt(12)
            paragraph2_1_run.font.name = '仿宋'
            ...
            #表例
            table_num = table_num + 1
            paragraph2_5_text = str('表'+str(table_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型技术待机损失统计表')
            paragraph2_5 = document.add_paragraph()
            paragraph2_5_run = paragraph2_5.add_run(paragraph2_5_text)
            paragraph2_5_run.font.size = Pt(10)
            paragraph2_5_run.font.name = '黑体'
            ...
            for i in range(device_num):
                for j in range(len(column_width)):
                    if i == 0:
                        ...
                        if j == 0:
                            fill_table(tablez2_5, x=i, y=j, content=conver_to_str(Technology_loss_all.iloc[i-1]['wtid']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 1:
                            fill_table(tablez2_5, x=i, y=j, content=int(Technology_loss_all.iloc[i-1]['count']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 2:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(Technology_loss_all.iloc[i-1]['time']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 3:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(Technology_loss_all.iloc[i-1]['loss']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 4:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(Technology_loss_all.iloc[i-1]['wspd']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 5:
                            fill_table(tablez2_5, x=i, y=j, content=str(Technology_loss_all.iloc[i-1]['fault_describe']), font_name='仿宋', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
        else:
            paragraph2_1_text = '分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组未发生技术待机情况。'      
            paragraph2_1 = document.add_paragraph()
            paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
            paragraph2_1_run.font.size = Pt(12)
            paragraph2_1_run.font.name = '仿宋'
    ...
    for typei in range(trubine_type):
        ...
        path = str(str(path_farm)+'/'+str(np.unique(Turbine_attr['turbineTypeID'])[typei]))
        stop_loss_all = pd.read_csv(str(path+'/stop_loss_all.csv'),header=[0],index_col=[0])
        
        if (metric_tongji.loc[0]['stop_loss'] > 200)&(len(stop_loss_all)>0):
            paragraph2_1_text = ('分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组计划停机损失电量共'+'{:.1f}'.format(metric_tongji.loc[0]['stop_loss'])+'kWh，折合等效小时'+
                                '{:.1f}'.format(metric_tongji.loc[0]['stop_loss']/WindFarm.loc[0,'容量']/1000)+'h，详细损失统计见下图表。')   
            paragraph2_1 = document.add_paragraph()
            paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
            paragraph2_1_run.font.size = Pt(12)
            paragraph2_1_run.font.name = '仿宋'
            ...
            #表例
            table_num = table_num + 1
            paragraph2_5_text = str('表'+str(table_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型计划停机损失统计表')
            paragraph2_5 = document.add_paragraph()
            paragraph2_5_run = paragraph2_5.add_run(paragraph2_5_text)
            paragraph2_5_run.font.size = Pt(10)
            paragraph2_5_run.font.name = '黑体'
            ...
            for i in range(device_num):
                for j in range(len(column_width)):
                    if i == 0:
                        ...
                        if j == 0:
                            fill_table(tablez2_5, x=i, y=j, content=conver_to_str(stop_loss_all.index[i-1]), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 1:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(stop_loss_all.iloc[i-1]['time']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 2:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(stop_loss_all.iloc[i-1]['loss']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 3:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(stop_loss_all.iloc[i-1]['wspd']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                        elif j == 4:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(stop_loss_all.iloc[i-1]['exltmp']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
        else:
            paragraph2_1_text = '分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组未发生计划停机情况。'      
            paragraph2_1 = document.add_paragraph()
            paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
            paragraph2_1_run.font.size = Pt(12)
            paragraph2_1_run.font.name = '仿宋'
...
#---------------------------------------------------------------------------------------
    ...
    for i in range(trubine_type):
        path = str(str(path_farm)+'/'+str(np.unique(Turbine_attr['turbineTypeID'])[i]))
        power_tongji = pd.read_csv(str(path+'/turbine_err_all.csv'),header=[0],index_col=[0])
        ...
        paragraph2_1_text = ('分析时段内，'+windfarm_name+str(np.unique(Turbine_attr['turbineTypeID'])[i])+'机型功率曲线一致性'+yizhi+
        ...
        #图补
        wtids = Turbine_attr[Turbine_attr['turbineTypeID']==np.unique(Turbine_attr['turbineTypeID'])[i]]
        turbine_num = 16
        ...
        if pnum > 0: 
            ...
            for j_pw in range(pnum_new):
                ...
                figure_path = str(str(path)+'/'+'/'+'功率曲线'+str(j_pw) +'.png')
                paragraph_picture2_4 = document.add_paragraph()
                paragraph_picture2_4.alignment = WD_ALIGN_PARAGRAPH.CENTER
                paragraph_picture2_4_run = paragraph_picture2_4.add_run()
                paragraph_picture2_4_run.add_picture(figure_path,width=Cm(14))
                ...
                #图示
                picture_num += 1
                paragraph2_4_text = str('图'+str(picture_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[i])+'机型功率曲线'+str(j_pw+1))
                paragraph2_4 = document.add_paragraph()
                paragraph2_4_run = paragraph2_4.add_run(paragraph2_4_text)
                paragraph2_4_run.font.size = Pt(10)
                paragraph2_4_run.font.name = '黑体'
                ...
                figure_path = str(str(path)+'/'+'/'+'Cp曲线'+str(j_pw) +'.png')
                paragraph_picture2_4 = document.add_paragraph()
                paragraph_picture2_4.alignment = WD_ALIGN_PARAGRAPH.CENTER
                paragraph_picture2_4_run = paragraph_picture2_4.add_run()
                paragraph_picture2_4_run.add_picture(figure_path,width=Cm(14))
                ...
                #图示
                picture_num += 1
                paragraph2_4_text = str('图'+str(picture_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[i])+'机型Cp曲线'+str(j_pw+1))
                paragraph2_4 = document.add_paragraph()
                paragraph2_4_run = paragraph2_4.add_run(paragraph2_4_text)
                paragraph2_4_run.font.size = Pt(10)
                paragraph2_4_run.font.name = '黑体'
            ...
            figure_path = str(str(path)+'/'+'/'+'功率曲线'+str(pnum+1) +'.png')
            paragraph_picture2_4 = document.add_paragraph()
            paragraph_picture2_4.alignment = WD_ALIGN_PARAGRAPH.CENTER
            paragraph_picture2_4_run = paragraph_picture2_4.add_run()
            paragraph_picture2_4_run.add_picture(figure_path,width=Cm(14))
            ...
            #图示
            picture_num += 1
            paragraph2_4_text = str('图'+str(picture_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[i])+'机型功率曲线')
            paragraph2_4 = document.add_paragraph()
            paragraph2_4_run = paragraph2_4.add_run(paragraph2_4_text)
            paragraph2_4_run.font.size = Pt(10)
            paragraph2_4_run.font.name = '黑体'
            ...
            figure_path = str(str(path)+'/'+'/'+'Cp曲线'+str(pnum+1) +'.png')
            paragraph_picture2_4 = document.add_paragraph()
            paragraph_picture2_4.alignment = WD_ALIGN_PARAGRAPH.CENTER
            paragraph_picture2_4_run = paragraph_picture2_4.add_run()
            paragraph_picture2_4_run.add_picture(figure_path,width=Cm(14))
            ...
            #图示
            picture_num += 1
            paragraph2_4_text = str('图'+str(picture_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[i])+'机型Cp曲线')
            paragraph2_4 = document.add_paragraph()
            paragraph2_4_run = paragraph2_4.add_run(paragraph2_4_text)
            paragraph2_4_run.font.size = Pt(10)
            paragraph2_4_run.font.name = '黑体'
...
#---------------------------------------------------------------------------------------
    ...
    for typei in range(trubine_type):
        ...
        path = str(str(path_farm)+'/'+str(np.unique(Turbine_attr['turbineTypeID'])[typei]))
        err_result_all = pd.read_csv(str(path+'/err_result_all.csv'),header=[0],index_col=[0])
        print(path)
        if len(err_result_all) > 0:
            err_temp = err_result_all[(np.abs(err_result_all['yawerr'])>5.0)&(np.abs(err_result_all['yawerr'])<999)]
            #err_temp = err_temp.reset_index()
            if len(err_temp)>0:
                paragraph2_1_text = ('分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型部分机组存在偏航对风不正问题，详细见下表。')   
                paragraph2_1 = document.add_paragraph()
                paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
                paragraph2_1_run.font.size = Pt(12)
                paragraph2_1_run.font.name = '仿宋'
                ...
                #表例
                table_num = table_num + 1
                paragraph2_5_text = str('表'+str(table_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型偏航对风不正机组统计表')
                paragraph2_5 = document.add_paragraph()
                paragraph2_5_run = paragraph2_5.add_run(paragraph2_5_text)
                paragraph2_5_run.font.size = Pt(10)
                paragraph2_5_run.font.name = '黑体'
                ...
                for i in range(len(err_temp)+1):
                    ...
                    for j in range(len(column_width)):
                        if i == 0:
                            ...
                            print(err_temp.iloc[i-1]['turbine'])
                            if j == 0:
                                fill_table(tablez2_5, x=i, y=j, content=conver_to_str(err_temp.iloc[i-1]['turbine']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                            elif j == 1:
                                figure_path = glob.glob(path+'/'+conver_to_str(err_temp.iloc[i-1]['turbine'])+'*yawerror.png')[0]
                                #print(figure_path)
                                ...
                                fill_table(tablez2_5, x=i, y=j, content='{:.2f}'.format(err_temp.iloc[i-1]['yawerr']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                            elif j == 3:
                                fill_table(tablez2_5, x=i, y=j, content='{:.2%}'.format(err_temp.iloc[i-1]['loss']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
            else:            
                err_temp = err_result_all[(np.abs(err_result_all['yawerr'])<=5.0)]
                if len(err_temp) > 0:
                    paragraph2_1_text = '分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组不存在较明显的偏航对风不正情况。如下图为某机组的偏航误差角度-发电性能散点图，误差角度小于5度。'      
                    paragraph2_1 = document.add_paragraph()
                    paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
                    paragraph2_1_run.font.size = Pt(12)
                    paragraph2_1_run.font.name = '仿宋'
                    ...
                    figure_path = glob.glob(path+'/'+str(err_temp.iloc[0]['turbine'])+'*yawerror.png')[0]
                    paragraph_picture2_4 = document.add_paragraph()
                    paragraph_picture2_4.alignment = WD_ALIGN_PARAGRAPH.CENTER
                    paragraph_picture2_4_run = paragraph_picture2_4.add_run()
                    paragraph_picture2_4_run.add_picture(figure_path,width=Cm(14))
                    ...
                    #图示
                    picture_num += 1
                    paragraph2_4_text = str('图'+str(picture_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型'+str(err_temp.iloc[0]['turbine'])+'机组偏航误差角度-发电性能散点图')
                    paragraph2_4 = document.add_paragraph()
                    paragraph2_4_run = paragraph2_4.add_run(paragraph2_4_text)
                    paragraph2_4_run.font.size = Pt(10)
                    paragraph2_4_run.font.name = '黑体'
                    ...
                    paragraph2_1_text = '分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组不存在较明显的偏航对风不正情况。'      
                    paragraph2_1 = document.add_paragraph()
                    paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
                    paragraph2_1_run.font.size = Pt(12)
                    paragraph2_1_run.font.name = '仿宋'
...
#---------------------------------------------------------------------------------------
    ...
    for typei in range(trubine_type):
            ...
            if len(err_temp)>0:
                paragraph2_1_text = ('风力发电机组的偏航对风角度一般控制在-10°～+10°之间。分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型部分机组偏航对风控制误差较大，详细见下表，偏航控制具有一定优化空间。')   
                paragraph2_1 = document.add_paragraph()
                paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
                paragraph2_1_run.font.size = Pt(12)
                paragraph2_1_run.font.name = '仿宋'
                ...
                #表例
                table_num = table_num + 1
                paragraph2_5_text = str('表'+str(table_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型较大偏航控制误差统计表')
                paragraph2_5 = document.add_paragraph()
                paragraph2_5_run = paragraph2_5.add_run(paragraph2_5_text)
                paragraph2_5_run.font.size = Pt(10)
                paragraph2_5_run.font.name = '黑体'
                ...
                for i in range(device_num):
                    for j in range(len(column_width)):
                        if i == 0:
                            ...
                            if j == 0:
                                fill_table(tablez2_5, x=i, y=j, content=conver_to_str(err_temp.iloc[i-1]['wtid']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
                            elif j == 1:
                                figure_path = glob.glob(path+'/'+str(err_temp.iloc[i-1]['wtid'])+'_wdir0.png')[0]
                                fill_table(tablez2_5, x=i, y=j, picture=figure_path, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, topbottommargin=0.01, width=column_width[j], picture_width=column_width[j]*0.8) 
            else:
                pass
    #---------------------------------------------------------------------------------------
    ...
    for typei in range(trubine_type):
        ...
        if len(err_temp)>0:
            paragraph2_1_text = ('最小桨距角一般在0°左右，不同机型虽然需要根据叶片翼型及控制要求调整最小桨距角，但不会偏离0°太多。分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+
            ...
            #表例
            table_num = table_num + 1
            paragraph2_5_text = str('表'+str(table_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型最小桨距角异常分析统计表')
            paragraph2_5 = document.add_paragraph()
            paragraph2_5_run = paragraph2_5.add_run(paragraph2_5_text)
            paragraph2_5_run.font.size = Pt(10)
            paragraph2_5_run.font.name = '黑体'
                ...
                for j in range(len(column_width)):
                    if i == 0:
                        ...
                        if j == 0:
                            ...
                            figure_path = glob.glob(path+'/'+conver_to_str(err_temp.iloc[i-1]['wtid'])+'_最小桨距角异常.png')[0]
                            ...
                            figure_path = glob.glob(path+'/'+conver_to_str(err_temp.iloc[i-1]['wtid'])+'_pitch_min_err.png')[0]
                            fill_table(tablez2_5, x=i, y=j, picture=figure_path, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, topbottommargin=0.01, width=column_width[j], picture_width=column_width[j],picture_height=5.5) 
                        elif j == 3:
                            fill_table(tablez2_5, x=i, y=j, content='{:.2%}'.format(err_temp.iloc[i-1]['pitch_min_loss']), font_name='Times New Roman', font_size=10, bold=False, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, width=column_width[j]) 
        else:
            paragraph2_1_text = '分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组不存在最小桨距角异常情况。'      
            paragraph2_1 = document.add_paragraph()
            paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
            paragraph2_1_run.font.size = Pt(12)
            paragraph2_1_run.font.name = '仿宋'
    ...
    for typei in range(trubine_type):
        ...
        if len(err_temp)>0:
            paragraph2_1_text = ('变桨控制一般在风机功率将近额定时才会动作，控制上出于防止机组超速、降低机组载荷、保证净空要求的考虑会适当的让变桨提前动作，'+
                                 ...
                                 '分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+
            ...
            #表例
            table_num = table_num + 1
            paragraph2_5_text = str('表'+str(table_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型异常机组功率-桨距角散点图')
            paragraph2_5 = document.add_paragraph()
            paragraph2_5_run = paragraph2_5.add_run(paragraph2_5_text)
            paragraph2_5_run.font.size = Pt(10)
            paragraph2_5_run.font.name = '黑体'
                ...
                for j in range(len(column_width)):
                    if i == 0:
                        ...
                        if j == 0:
                            ...
                            figure_path = glob.glob(path+'/'+str(err_temp.iloc[i-1]['wtid'])+'_pitch_control_err.png')[0]
                            fill_table(tablez2_5, x=i, y=j, picture=figure_path, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, topbottommargin=0.01, width=column_width[j], picture_width=column_width[j]*0.8) 

        else:
            paragraph2_1_text = '分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组不存在变桨控制异常情况。'      
            paragraph2_1 = document.add_paragraph()
            paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
            paragraph2_1_run.font.size = Pt(12)
            paragraph2_1_run.font.name = '仿宋'
    ...
    for typei in range(trubine_type):
        ...
        if len(err_temp)>0:
            ...
            #表例
            table_num = table_num + 1
            paragraph2_5_text = str('表'+str(table_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型异常机组风速-桨距角散点图')
            paragraph2_5 = document.add_paragraph()
            paragraph2_5_run = paragraph2_5.add_run(paragraph2_5_text)
            paragraph2_5_run.font.size = Pt(10)
            paragraph2_5_run.font.name = '黑体'
                ...
                for j in range(len(column_width)):
                    if i == 0:
                        ...
                        if j == 0:
                            ...
                            figure_path = glob.glob(path+'/'+conver_to_str(err_temp.iloc[i-1]['wtid'])+'_pitch_balance_err.png')[0]
                            fill_table(tablez2_5, x=i, y=j, picture=figure_path, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, topbottommargin=0.01, width=column_width[j], picture_width=column_width[j]*0.8) 
        else:
            paragraph2_1_text = '分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组不存在变桨角度不平衡情况。'      
            paragraph2_1 = document.add_paragraph()
            paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
            paragraph2_1_run.font.size = Pt(12)
            paragraph2_1_run.font.name = '仿宋'
    ...
    for typei in range(trubine_type):
        ...
        if len(err_temp)>0:
            paragraph2_1_text = ('分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+
            ...
            #表例
            table_num = table_num + 1
            paragraph2_5_text = str('表'+str(table_num)+' '+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型异常机组转速-功率散点图')
            paragraph2_5 = document.add_paragraph()
            paragraph2_5_run = paragraph2_5.add_run(paragraph2_5_text)
            paragraph2_5_run.font.size = Pt(10)
            paragraph2_5_run.font.name = '黑体'
                ...
                for j in range(len(column_width)):
                    if i == 0:
                        ...
                        if j == 0:
                            ...
                            figure_path = glob.glob(path+'/'+conver_to_str(err_temp.iloc[i-1]['wtid'])+'_转矩kopt控制异常.png')[0]
                            fill_table(tablez2_5, x=i, y=j, picture=figure_path, paragraph_alignment=WD_PARAGRAPH_ALIGNMENT.CENTER, startendmargin=0, topbottommargin=0.01, width=column_width[j], picture_width=column_width[j]*0.8) 
        else:
            paragraph2_1_text = '分析时段内'+str(np.unique(Turbine_attr['turbineTypeID'])[typei])+'机型各机组不存在转矩控制异常情况。如下图为某机组的转速-功率散点图。'      
            paragraph2_1 = document.add_paragraph()
            paragraph2_1_run = paragraph2_1.add_run(paragraph2_1_text)
            paragraph2_1_run.font.size = Pt(12)
            paragraph2_1_run.font.name = '仿宋'
    ...
    paragraph2.paragraph_format.space_after = Pt(6)
    document.save(path_farm + '/' + windfarm_name + '能效评估报告.docx')
    return path_farm + '/' + windfarm_name + '能效评估报告.docx'
    '''
